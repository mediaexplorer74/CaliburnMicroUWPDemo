...
using UWP_WidgetCommunication.Widgets.CustomerInfo;
using UWP_WidgetCommunication.Widgets.NewCustomer;

namespace UWP_WidgetCommunication.Widgets.CustomerListWidget
{
